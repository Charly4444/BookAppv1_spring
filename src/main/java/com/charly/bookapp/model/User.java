...
//	These list of books this user owns
	...
	public User(Long id, String name, Long libcode, String password, List<Book> books) {
		super();
		this.id = id;
		this.name = name;
	...
	public User(Long id, String name, Long libcode, String password) {
		super();
		this.id = id;
		this.name = name;
		this.isLoggedin = false;
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", libcode=" + libcode + "]";
	}
